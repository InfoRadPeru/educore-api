...
describe('ConfirmarPrematriculaUseCase', () => {
  ...
  it('crea la matrícula y enlaza la prematricula al confirmar', async () => {
    ...
    mockPrematriculaRepo.actualizar.mockResolvedValue(
      Prematricula.reconstitute({
        id: 'pre-1', colegioId: 'colegio-1', alumnoId: 'alumno-1',
        colegioNivelId: 'nivel-1', seccionId: 'seccion-1', añoAcademico: 2026,
        estado: 'CONFIRMADA', observaciones: null, matriculaId: 'mat-1',
  ...
  it('falla con CONFLICT cuando la prematricula no está PENDIENTE', async () => {
